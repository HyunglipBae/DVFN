...
def decomposed_problems(n_stages, maximum_resource):
    """
...
def make_problem_definition(n_stages, maximum_resource):
    """
    ...
    problem, stage_to_prob = decomposed_problems(n_stages, maximum_resource)
